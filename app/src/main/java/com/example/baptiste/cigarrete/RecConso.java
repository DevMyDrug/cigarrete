...
/**
 * Cette classe est une activité, possède donc une vue. Elle permet de voir les objectifs consommable
 */
public class RecConso extends MainActivity {
ListView liste;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rec_conso);
        liste=(ListView)findViewById(R.id.ListConso);
        RecupInfo();
    }
    ...
    public void RecupInfo()
    {
        try
        {
            String[] intituler= getResources().getStringArray(R.array.RecompConsommation);
            String[] cond= getResources().getStringArray(R.array.condRecompConsommation);
