 ...
 */
public class RecSport extends MainActivity {
ListView liste;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rec_sport);
        liste=(ListView)findViewById(R.id.ListSport);
        RecupInfo();
    }
    ...
    public void RecupInfo()
    {
        try
        {
            String[] intituler= getResources().getStringArray(R.array.RecompMatosSportif);
            String[] cond= getResources().getStringArray(R.array.condMatosSportif);
